# -*- coding: utf-8 -*-
"""
@DATE: 2024-04-12 16:07:00
@Author: Liu Hengjiang
@File: examples\occhs_multi_label_classification\preprocess_data.py
@Software: vscode
@Description:
        对DEMO中要用到的数据进行特征工程
"""
...
if __name__ == "__main__":
    ...
    # preprocessed_df["labels"] = mlb.fit_transform(
    #     preprocessed_df["labels"].str.split(","))
    # pickle.dump(mlb, open(model_path / "multi_lable_encoder.pkl", "wb"))

    logger.info(f"Convert birthday")
    ...
    # 来自于pandas加载文件时的自动识别
    special_cols = [
        "GLU_result", "UncorrectedVisualAcuityLeft_result",
        # "VisualAcuityLeft_result", 
        "VisualAcuityRight_result", "Neu100_result",
        "UncorrectedVisualAcuity_LeftEye_result", "CorrectedVisionLeft_result",
        # "UrineCalcium_result", 
    ...
    for col in special_cols:
        for pattern, num in pattern_dict.items():
            preprocessed_df[col] = preprocessed_df[col].apply(
    ...
    output_file = output_path / "preprocessed_data_set.csv"
