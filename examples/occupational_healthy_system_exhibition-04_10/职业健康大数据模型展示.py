...
if __name__ == "__main__":
    root_path = "."
    # root_path = "/mount/src/occupational_health_system_v2/examples/occupational_healthy_system-04_10"
    ...
    st.markdown("### 数据采集")
    st.image(f"{root_path}/pictures/系统架构图-彩-Part1.png")
    st.markdown("""
    ...
    st.image(f"{root_path}/pictures/系统架构图-彩-Part2.png")
    st.markdown("""
    ...
    st.image(f"{root_path}/pictures/系统架构图-彩-Part3.png")
    st.markdown("""
                * 服务对象：研究人员；
    ...
    """)
    st.markdown("### 信息应用与共享")
    st.image(f"{root_path}/pictures/系统架构图-彩-Part4.png")
    st.markdown("""
