...
from occhs_time_series_predict.district_time_series_predict import CITY_NAMES
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_path", type=str, default="../occupational_healthy_system_models-04_10/occhs_time_series_predict/cache")
    parser.add_argument("--models_path", type=str, default="../occupational_healthy_system_models-04_10/occhs_time_series_predict/models")
    # parser.add_argument("--input_path", type=str, default="/mount/src/occupational_health_system_v2/examples/occupational_healthy_system_models-04_10/occhs_time_series_predict/cache")
    # parser.add_argument("--models_path", type=str, default="/mount/src/occupational_health_system_v2/examples/occupational_healthy_system_models-04_10/occhs_time_series_predict/models")
