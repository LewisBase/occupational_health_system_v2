...
from occhs_time_series_predict.disease_time_series_predict import OCCUPATIONAL_DISEASE_TYPE_NAME
...
if __name__ == "__main__":
    ...
    #                     type=str,
    #                     default="/mount/src/occupational_health_system_v2/examples/occupational_healthy_system_models-04_10/occhs_association_rule_mining/cache/disease_hazard_group_data.csv")
    # parser.add_argument("--models_path", type=str, default="/mount/src/occupational_health_system_v2/examples/occupational_healthy_system_models-04_10/occhs_association_rule_mining/models")
    parser.add_argument("--input_path",
                        type=str,
                        default="../occupational_healthy_system_models-04_10/occhs_association_rule_mining/cache/disease_hazard_group_data.csv")
    parser.add_argument("--models_path", type=str, default="../occupational_healthy_system_models-04_10/occhs_association_rule_mining/models")
