...
if __name__ == "__main__":
    ...
    #     type=str,
    #     default=
    #     "/mount/src/occupational_health_system_v2/examples/occupational_healthy_system_models-04_10/occhs_time_series_predict/cache"
    # )
    # parser.add_argument(
    #     "--models_path",
    #     type=str,
    #     default=
    #     "/mount/src/occupational_health_system_v2/examples/occupational_healthy_system_models-04_10/occhs_time_series_predict/models"
    # )
