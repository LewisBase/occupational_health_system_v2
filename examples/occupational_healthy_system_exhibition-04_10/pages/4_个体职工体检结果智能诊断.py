...
if __name__ == "__main__":
    ...
    #                     type=str,
    #                     default="/mount/src/occupational_health_system_v2/examples/occupational_healthy_system_models-04_10/occhs_multi_label_classification/cache/preprocessed_data_set.csv")
    # parser.add_argument("--models_path", type=str, default="/mount/src/occupational_health_system_v2/examples/occupational_healthy_system_models-04_10/occhs_multi_label_classification/models")
    parser.add_argument("--input_path",
                        type=str,
                        default="../occupational_healthy_system_models-04_10/occhs_multi_label_classification/cache/preprocessed_data_set.csv")
    parser.add_argument("--models_path", type=str, default="../occupational_healthy_system_models-04_10/occhs_multi_label_classification/models")
