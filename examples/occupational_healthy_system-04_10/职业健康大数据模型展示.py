...
if __name__ == "__main__":
    ...
    st.markdown("### 数据采集")
    st.image("/mount/src/occupational_health_system_v2/examples/occupational_healthy_system-04_01/pictures/系统架构图-彩-Part1.png")
    ...
    st.image("/mount/src/occupational_health_system_v2/examples/occupational_healthy_system-04_01/pictures/系统架构图-彩-Part2.png")
    ...
    st.image("/mount/src/occupational_health_system_v2/examples/occupational_healthy_system-04_01/pictures/系统架构图-彩-Part3.png")
    ...
    """)
    st.markdown("### 信息应用与共享")
    st.image("/mount/src/occupational_health_system_v2/examples/occupational_healthy_system-04_01/pictures/系统架构图-彩-Part4.png")
